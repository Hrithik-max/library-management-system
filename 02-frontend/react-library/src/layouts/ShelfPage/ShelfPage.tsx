            ...
            <div className='mt-3'>
                <nav>
                    <div className='nav nav-tabs' id='nav-tab' role='tablist'>
                        ...
                        <button onClick={() => setHistoryClick(true)} className='nav-link' id='nav-history-tab' data-bs-toggle='tab' data-bs-target='#nav-history' type='button' role='tab' aria-controls='nav-history'>
                            Your History
                        </button>
                    </div>
                </nav>
